...
Insights
StartUp/Exercicio
@GabrielBraun12 GabrielBraun12 Create Exercicio 7716052 7 days ago
368 lines (327 sloc) 9.96 KB
#include <iostream>
#include <string>
...
void cadastrar_startup()
{
    ...
    do
    {
        ...
        cout << "Digite o Valor de fomento:";
        cin >> val_fomento_temp;
